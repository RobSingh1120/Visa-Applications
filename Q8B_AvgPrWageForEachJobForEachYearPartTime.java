...
public class Q8B_AvgPrWageForEachJobForEachYearPartTime {
	...
	public static void main(String[] args) throws Exception {
		...
		Job job1 = Job.getInstance(conf, "Average Prevailing Wage for Part Time each Job for each Year");
		...
		Path outputpath1 = new Path("Parttime1");
		...
		Job job2 = Job.getInstance(conf, "Average Prevailing Wage for Part Time each Job for each Year");
